<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="glyphicon glyphicon-text-background"></i> Danh sách bài viết(<?php echo $total_rows?>)</h1>
								...
								<table class="table table-hover table-bordered">
									<thead>
										<tr>
											...
											<th class="text-center" style="width:50px">Chi tiết</th>
									...
									<?php foreach ($list as $val):?>
										<tr style="background:<?php $val['view']==0?'red':'blue'; ?>">
											...
											<!-- -------------- -->
											<td class="text-center">
												<a class="btn btn-info btn-xs" href="<?php echo base_url() ?>admin/contact/detail/<?php echo $val['id'] ?>" role = "button">
													<span class="glyphicon glyphicon-eye-open"></span> Xem
												</a>
											</td>
											<!-- ------------ -->
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/contact/delete/<?php echo $val['id'] ?>" onclick="return confirm('Xác nhận xóa bài viết này ?')" role = "button">
