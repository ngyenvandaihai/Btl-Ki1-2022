<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="glyphicon glyphicon-user"></i> Danh sách khách hàng (<?php echo $total_rows?>)</h1>
									...
									<?php foreach ($list as $val):?>
										...
										<tr>
											...
											<?php echo $val['fullname'] ?>
												<!-- <a href="<?php echo base_url() ?>admin/customer/update/<?php echo $val['id'] ?>">
												<?php echo $val['fullname'] ?>
												</a>	 -->
											</td>
											...
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/customer/delete/<?php echo $val['id'] ?>" onclick="return confirm('Xác nhận xóa tài khoản khách hàng này ?')" role = "button">
