<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="glyphicon glyphicon-cd"></i> Danh sách tài khoản (<?php echo $total_rows?>)</h1>
											...
											<td class="text-center">
												<a href="<?php echo base_url() ?>admin/useradmin/status/<?php echo $val['id'] ?>">
													...
													<?php endif; ?>
														...
														<td class="text-center">
															<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/useradmin/update/<?php echo $val['id']?>" role = "button">
														...
														<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/order/delte/<?php echo $val['id'] ?>" onclick="return confirm('Xác nhận xóa tài khoản admin này ?')" role = "button">
