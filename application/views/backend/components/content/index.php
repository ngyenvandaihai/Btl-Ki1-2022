								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/content/delete/<?php echo $val['id'] ?>" onclick="return confirm('Xác nhận xóa bài viết này ?')" role = "button">
