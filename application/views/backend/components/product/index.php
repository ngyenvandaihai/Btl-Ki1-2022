<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="glyphicon glyphicon-cd"></i> Danh sách sản phẩm (<?php echo $total_rows?>)</h1>
								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td><a href="<?php echo base_url() ?>admin/product/update/<?php echo $val['id'] ?>"><?php echo $val['name'] ?> ( <?php echo $val['number'] ?> )</a><br><p style="font-size: 10px;color: #767373;">Đã bán <?php echo $val['number_buy'] ?></p></td>
											<?php 
											...
											<td class="text-center">
												<a href="<?php echo base_url() ?>admin/product/status/<?php echo $val['id'] ?>">
													<?php if($val['status']==1||$val['status']==2):?>
														<span class="glyphicon glyphicon-ok-circle mauxanh18" title="Vẫn bán"></span>
													<?php else: ?>
														<span class="glyphicon glyphicon-remove-circle maudo" title="Tạm ngừng bán"></span>
													<?php endif; ?>
												</a>
											</td>
											<td class="text-center">
											...
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/product/delete/<?php echo $val['id'] ?>" onclick="return confirm('Xác nhận xóa sản phẩm này ?')" role = "button">
