	...
	<section class="content-header">
	    ...
	    <div class="breadcrumb">
			...
			<?php if( $order['status']==0 ):?>
				<a class="btn btn-primary btn-sm" style="background-color: #dfcf39;border-color: #dfcf39;" href="<?php echo base_url() ?>admin/orders/tuchoi/<?php echo $order['id'] ?>" role = "button">
					<span class="glyphicon glyphicon-remove do_nos"></span> từ chối đơn
				</a>
			
			<?php elseif($order['status']==2||$order['status']==3):?>
				<a class="btn btn-primary btn-sm" style="background-color: #dfcf39;border-color: #dfcf39;" href="<?php echo base_url() ?>admin/orders/huydon/<?php echo $order['id'] ?>" role = "button">
					<span class="glyphicon glyphicon-remove do_nos"></span> hủy đơn
				</a>
			<?php endif;?>
			<!-- <a class="btn btn-primary btn-sm" style="background-color: #dfcf39;border-color: #dfcf39;" href="<?php echo base_url() ?>admin/orders/huydon/<?php echo $order['id'] ?>" role = "button">
				<span class="glyphicon glyphicon-remove do_nos"></span> hủy đơn
	                ...
	                <div class="box-body">
	                    ...
	                    <div id="view">
	                        ...
	                        ?>
								...
								<h4>Địa chỉ: <i><?php echo $order['address']; ?>, </i>
								        ...
								        <?php endforeach; ?>
								        	...
								        	<tr>
								                <td class="text-right" colspan="6">
													...
													<!-- <a class="btn btn-primary btn-md" style="background-color: #dfcf39;border-color: #dfcf39;" href="<?php echo base_url() ?>admin/orders/huydon/<?php echo $order['id'] ?>" role = "button">
														<span class="glyphicon glyphicon-remove do_nos"></span> hủy đơn
													</a> -->
								                </td>
								            </tr>
