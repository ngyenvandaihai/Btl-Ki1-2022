<html lang="">
	<head>
        ...
        <title>Beauty Shop-Trang quản trị</title>
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#8ac400">Beauty Shop</h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2022
                   <!-- <a href="https://www.facebook.com/trungphatit" style="color:red">
                   PYWeb</a> -->
                   . Vương Thủy Nguyên</h5>
            </div>
        </nav>
        <!-- jQuery -->
