<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="fa fa-gift"></i> Danh sách các thương hiệu (<?php echo $total_rows?>)</h1>
								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/producer/delete/<?php echo $val['id'] ?>" onclick="return confirm('Xác nhận xóa thương hiệu này ?')" role = "button">
