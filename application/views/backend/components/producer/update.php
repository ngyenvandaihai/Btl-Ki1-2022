...
<div class="content-wrapper">
	<form action="<?php echo base_url() ?>admin/producer/update.html" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
		<section class="content-header">
			<h1><i class="glyphicon glyphicon-text-background"></i> Cập nhật thương hiệu</h1>
								...
								<div class="box-body">
									<div class="col-md-9">
										<div class="form-group">
											<label>Tên thương hiệu <span class = "maudo">(*)</span></label>
										...
										<div class="form-group">
											...
											<span style="font-style: italic; line-height: 32px;">Chú ý: Mỗi từ khóa phân cách bởi một dấu ","</span>
											<div class="error" id="password_error" style="color: red"><?php echo form_error('keyword')?></div>
										</div>
										<div class="form-group">
											<label>Trạng thái</label>
											<select name="status" class="form-control">
												<option value="1" <?php if($row['status'] == 1) {echo 'selected';}?> >Vẫn kinh doanh</option>
												<option value="0" <?php if($row['status'] == 0) {echo 'selected';}?>>Tạm ngừng kinh doanh</option>
											</select>
										</div>
									</div>
								</div>
