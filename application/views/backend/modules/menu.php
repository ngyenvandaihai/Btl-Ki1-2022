        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="<?php echo base_url()?>admin/category">
                    <i class="fa fa-indent"></i><span>Danh mục sản phẩm</span>
                </a>
            </li>
            <li class="treeview">
                <a href="<?php echo base_url()?>admin/producer">
                    <i class="fa fa-gift"></i><span>Thương hiệu</span>
                </a>
            </li>
            ...
            <li>
                <a href="<?php echo base_url() ?>admin/orders">
                    <i class="fa fa-shopping-cart"></i> Giao dịch
                </a>
            </li>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="active">
                        <a href="<?php echo base_url() ?>admin/configuration/update">
                            <i class="fa fa-cogs"></i> Mail hệ thống
                        </a>
                    </li>
                    <?php 
                        $cpnGroup='';
