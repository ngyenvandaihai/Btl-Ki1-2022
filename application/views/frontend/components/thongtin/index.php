                                ...
                                <tbody>
                                    ...
                                    foreach ($order as $value):?>
                                        <tr class="first odd">
                                            ...
                                            <td>
                                                <?php if($value['status']==0):?> <p>Đơn chưa được xác nhận</p>
                                                    <?php elseif($value['status']==1):?> <p>Đơn đã giao thành công</p>
                                                    <?php elseif($value['status']==2):?> <p>Đơn hàng đã được xác nhận</p>
                                                    <?php elseif($value['status']==3):?> <p>Đơn hàng đang được giao</p>
                                                <?php endif?>
                                            </td>
                                            <td class="a-center last"><span class="nobr"> <a href="account/orders/<?php echo $value['id'] ?>">Xem chi tiết</a>
        ...
        <aside class="col-right sidebar col-md-3 col-xs-12">
            <div class="block block-account">
                ...
                <div class="block-content">
                    ...
                    <button class="btn"><a href="thongtin/reset_password">Đổi mật khẩu</a></button>
                </div>
            </div>
        </aside>
    </div>
