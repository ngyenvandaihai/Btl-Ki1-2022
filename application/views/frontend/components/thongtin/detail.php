<div class="container order-page">
	...
	<div class="or-detail-c">
		...
		<!-- <div class="col-xs-12">
		<a class="btn btn-primary btn-sm" style="background-color: red;border-color: red;" href="<?php echo base_url() ?>/thongtin/huy/<?php echo $info['id'] ?>" role = "button">
					<span class="glyphicon glyphicon-remove do_nos"></span> hủy đơn
				</a>
		</div> -->
		<div class="col-xs-12">
			<a href="javascript:;" onclick="window.history.go(-1);" class="viewMore pull-left" style="font-size: 15px;margin-top: 15px;"><i class="fa fa-angle-left" aria-hidden="true"></i> Trở về trang trước</a>
		</div>
	</div>
</div>