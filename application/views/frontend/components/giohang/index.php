										...
										<tr>
											...
											<td>
												<div class="quantity clearfix">
													...
													min="1" max="<?php echo $row['number'] ?>" onchange="onChangeSL(<?php echo $row['id'] ?>)" pattern="[0-<?php echo $row['number'] ?>]*">
									...
									<tbody>
										...
										<tr>
											<td colspan="2">
													...
													<?php if( $value > $row['number']):	?>
														<button type="button"  class="btn-next-checkout" onchange="onChangeSL(<?php echo $row['id'] ?>)" >Không thể đặt hàng do quá số lượng</button>
														
													<?php else :?>
														<button type="button" onclick="window.location.href='checkout'" class="btn-next-checkout" onchange="onChangeSL(<?php echo $row['id'] ?>)" >Thanh toán</button>
										...
										<tr>
											<td colspan="2">
												<button type="button" onclick="window.history.go(-2);" class="btn-update-order">Tiếp tục mua hàng</button>
											</td>
										</tr>
									</tbody>
								</table>
