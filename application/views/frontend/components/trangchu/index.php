    ...
    <div class="container">
        <div class="banner">
            <div class="item-banner">
                <a href="">
                    <img src="public/images/bb1.jpg">
                </a>
            </div> 
            <div class="item-banner">
                <a href="">
                    <img src="public/images/bb4.jpg">
                </a>
            </div>
            <div class="item-banner">
                <a href="">
                    <img src="public/images/bb04.png">
                </a>
            </div>
        </div>
    </div>
...
<!-- ------------ -->
<div class="container" style="margin-top: 40px ; width: 1140px;border-top: 1px solid #e8e6e2;border-right: 1px solid #e8e6e2;border-left: 1px solid #e8e6e2;">
    <div class="sale-title" style="color: #ff9800;font-weight: bold;font-size: 25px; line-height: 56px;border-bottom: 1px solid #e8e6e2;">
        <span>SẢN PHẨM KHUYẾN MÃI </span>
    </div>
</div>
<div class="container" style="margin-bottom: 20px; width: 1170px;">
<div class="products-grid clearfix" style="border: 1px solid #e8e6e2;padding:20px; border-top:none;" >
        <?php 
        $product_sale = $this->Mproduct->product_sale(10);
        foreach ($product_sale as $row) :?>
            <div class="item col-md-3 col-sm-3 col-xs-6 product-one" style="width: 195px;margin-left: 20px;margin-right: 20 px;">
...
<div class="products-grid clearfix" style="border: 1px solid #e8e6e2;padding:20px; border-top:none;" >
        <?php 
        $product_news = $this->Mproduct->product_news(10);
...
<div class="container" style="margin-bottom: 20px; width: 1170px;">
<div class="products-grid clearfix" style="border: 1px solid #e8e6e2;padding:20px; border-top:none;min-height: 280px;" >
        <?php 
        $product_salling = $this->Mproduct->product_selling(5);
        foreach ($product_salling as $row) :?>
            <div class="item col-md-3 col-sm-3 col-xs-6 product-one" style="width: 195px;margin-left: 20px;margin-right: 20 px;">
                                        <div class="image-product">
                                        <a href="<?php echo $row['alias'] ?>" title="<?php echo $row['name'] ?>">
                                            <img src="public/images/products/<?php echo $row['avatar'] ?>" alt="" class="img-bg">
...
<!-- <section id="content">
    <div class="container">
        ...
        <?php 
            ...
            if(count($subCategory) && (count($listProducts) >= 3)):?>
...
<section class="home-blog" >
    <div class="container">
        <div class="title-line">
            <h2 class="title" style="color: #ff9800;font-weight: bold;font-size: 25px;line-height: 56px;">Tin tức</h2>
        </div>
...
<section id="demos">
    <div class="container">
        <div class="brands">
            <div class="col-md-3">
                <h2>Nhãn hiệu</h2>
                <p class="desc">Những nhãn hiểu nổi tiếng với chất lượng cao đã được chúng tôi lựa chọn, cam kết không làm bạn thất vọng.</p>
            </div>
            <div class="col-md-9">
